...
<div id="main-wrap" class="animated fadeIn">
    ...
    <div class="main-content">
        ...
        <form class="layui-form" action="${pageContext.request.contextPath}/Goods/fileUpload" enctype="multipart/form-data" method="post">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="stylesize" required  lay-verify="required" placeholder="手机配置" autocomplete="off" class="layui-input">
                </div>
            </div>
